...
var router;
var WindAPIUtils = require('./utils/WindAPIUtils');
...
// Fetch meteo data once and start to fetch meteo data every 30s
WindAPIUtils.getMeteoData();
var meteoDataTimer = setInterval(WindAPIUtils.getMeteoData, 30000);
